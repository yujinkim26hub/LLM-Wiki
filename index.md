...
> You curate sources and ask questions. The LLM reads each source in full, distills it into a summary, and weaves it into a graph of concepts, topics, entities, and synthesis notes. Knowledge here is meant to **compound** — every ingest leaves the wiki measurably richer.
...
| [[20-Entities/index\|People & labs]] | People, organizations, places, products, projects |
